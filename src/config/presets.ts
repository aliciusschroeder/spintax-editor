export const exampleYaml = `intro: >-
  {Welcome to|Discover|Step into} the 
  {world|realm|universe} of 
  {effortless|smart|automated} content creation.

featureHighlight: >-
  Our tool {lets you|empowers you to|makes it easy to} 
  {generate|spin|create} {engaging|unique|on-brand} 
  text in {seconds|no time|a flash}.
